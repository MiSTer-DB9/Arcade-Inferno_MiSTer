...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Inferno_MiSTer.git"
CORE_NAME=(Arcade-Inferno)
...
UPSTREAM_CORE_NAME=(Arcade-Inferno)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-Inferno.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Inferno.rbf)
